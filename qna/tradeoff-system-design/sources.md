...
|--------|-----------|-------|
| SWE-vs-DS skills table — Google Doc `1rQPFySmhmE0e4LPnfDEFPbTG3yJvPPojyN3o6i4hjLI` | Grading rubric behind `qc-eval.md`; 5 buckets / 17 tasks. | Read-only. Mirror target: `syllabus/ml-swe-collab.md` (not yet created) — edit the mirror, never the Doc. |
| Resume — Oracle / Primavera bullets | Factual anchor: Monte Carlo ~40% perf, weather-attributes rules engine, import/export, Jenkins −50%. | True facts. Target: `personal-context/resume.md` (not yet created). |
