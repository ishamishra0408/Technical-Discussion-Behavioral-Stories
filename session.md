...
**Last session goal:** none yet under flow v2 — next initiate defines it.
**Date:** 2026-07-06 · **Since last:** flow v2 adopted (initiate wizard → compiled voice-session.md briefing → gate merges state).
